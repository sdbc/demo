...
//计算软座
//	fee_p->RZ_fee=fround(fround(r*fround(2.0*tmp,5,0),5,0)+insum,5,0);//先上浮再加保险费
	fee_p->RZ_fee=fround(r*fround(2.0*tmp+insum,5,0),5,0);//先加保险费再上浮 
